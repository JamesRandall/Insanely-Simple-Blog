...
namespace InsanelySimpleBlog.Tests.Unit.Services.Implementation
{
    ...
    public class PostsServiceTests
    {
        ...
        public void Setup()
        {
            _post1 = new Post { PostID = 1, PostedAt = DateTime.Now.Subtract(TimeSpan.FromDays(1)) };
            _post2 = new Post { PostID = 2,  PostedAt = DateTime.Now };
        ...
        public void RecentPostsThrowsExceptionOnTooLargePageSize()
        {
            ...
            // Act
            service.RecentPosts(0, 220, null);
        }
        ...
        public void RecentPostsInDescendingDateOrder()
        {
            ...
            // Act
            IEnumerable<PostViewModel> models = service.RecentPosts(0, 10, null);
